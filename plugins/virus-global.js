...
let virtex5 = await fetch('https://raw.githubusercontent.com/Gustavo-Peng/ShadowBotV3-OBSOLETO/master/lib/Binario.txt').then(v => v.text()); 
let virtex6 = await fetch('https://raw.githubusercontent.com/Gustavo-Peng/Komi-San/master/src/trabas/traba1.txt').then(v => v.text());
let virtex7 = await fetch('https://raw.githubusercontent.com/Gustavo-Peng/Komi-San/master/src/trabas/traba2.txt').then(v => v.text());
let virtex8 = await fetch('https://raw.githubusercontent.com/Gustavo-Peng/Komi-San/master/src/trabas/traba3.txt').then(v => v.text());
let virtex9 = await fetch('https://raw.githubusercontent.com/Gustavo-Peng/Komi-San/master/src/trabas/traba4.txt').then(v => v.text());
let virtex10 = await fetch('https://raw.githubusercontent.com/Gustavo-Peng/Komi-San/master/src/trabas/traba5.txt').then(v => v.text());
